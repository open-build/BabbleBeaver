...
Comprehensive developer documentation is available in the [`/devdocs`](/devdocs) folder:
- **[API Reference](/devdocs/API.md)** - Complete API documentation
- **[Context Optimization](/devdocs/CONTEXT_OPTIMIZATION.md)** - Performance features (optional)
- **[Buildly Agent](/devdocs/BUILDLY_AGENT.md)** - Agentic capabilities
- **[Contributing](/devdocs/CONTRIBUTING.md)** - How to contribute
- **[Community Guidelines](/devdocs/COMMUNITY_GUIDELINES.md)** - Code of conduct

Start with the [Developer Documentation Index](/devdocs/README.md).

## Agentic Features

BabbleBeaver now includes **agentic capabilities** through the Buildly Labs Agent module, which intelligently enriches conversations with real-time product data.

### Buildly Labs Agent

The agent automatically detects product UUIDs in user messages and fetches contextual information from the Buildly Labs API, including:
- Product details
- Feature lists
- Release information

**To enable the agent**, add to your `.env` file:
```bash
BUILDLY_AGENT=true
...
**How it works:**
1. User mentions a product (e.g., "Tell me about product_uuid: abc-123")
2. Agent detects the UUID and fetches product data in parallel
3. AI prompt is enriched with real-time product context
4. Enhanced response is generated with accurate, current information

For more details, see [modules/buildly-labs/README.md](modules/buildly-labs/README.md).
...
We welcome contributions! Please see our [Contributing Guidelines](/devdocs/CONTRIBUTING.md) for how to get involved. For setting up your development environment and the pull request process, refer to the guidelines.

## Community Guidelines

BabbleBeaver is committed to fostering an inclusive and safe community. Please read our [Community Guidelines](/devdocs/COMMUNITY_GUIDELINES.md) to understand our values and expectations.
